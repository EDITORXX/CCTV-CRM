    ...
    <div class="login-wrapper">
        ...
        <div class="login-card">
            ...
            <a href="{{ route('google.redirect') }}" class="btn w-100 d-flex align-items-center justify-content-center gap-2"
               style="background: #fff; border: 1.5px solid #dee2e6; border-radius: .5rem; padding: .65rem; font-weight: 500; font-size: .9rem; color: #3c4043; transition: all .2s;"
            ...
            @if (session('error'))
                <div class="alert alert-danger mt-3 mb-0 py-2 small text-center" role="alert">
                    {{ session('error') }}
                </div>
            @endif
        </div>

...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="mb-1">Add Site Expense</h4>
        <p class="text-muted mb-0">Record an expense for a customer site</p>
    </div>
...
<div class="card border-0 shadow-sm">
    <div class="card-body">
        <form action="{{ route('site-expenses.store') }}" method="POST">
            @csrf
            <div class="row g-3">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    @error('site_id')<span class="text-danger small">{{ $message }}</span>@enderror
                </div>
                <div class="col-md-12">
                    <label for="description" class="form-label">Description <span class="text-danger">*</span></label>
                    <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description"
                              rows="3" required placeholder="What was the expense for?">{{ old('description') }}</textarea>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control @error('technician_name') is-invalid @enderror" id="technician_name" name="technician_name"
                           value="{{ old('technician_name', auth()->user()->name) }}">

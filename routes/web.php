...
// Estimate templates (was Quotations – merged into Estimates)
    ...
    Route::get('/api/products-list', [App\Http\Controllers\ProductController::class, 'getList'])->name('api.products.list');
    Route::post('/api/products/quick-store', [App\Http\Controllers\ProductController::class, 'quickStore'])->name('api.product.quick-store');
